export default function InfoPage({ config }) {
  ...
  return (
    <div style={{ paddingTop: "24px", maxWidth: "700px", margin: "0 auto" }}>
      <h1 style={{ fontSize: "24px", fontWeight: 800, marginBottom: "6px" }}>Informacion y precios</h1>
      ...
      <div style={{ background: "#141414", border: "1px solid #1e1e1e", borderRadius: "14px", padding: "20px", marginBottom: "16px" }}>
        ...
        <div style={{ borderTop: "1px solid #1e1e1e", marginTop: "12px", paddingTop: "12px" }}>
          <div style={{ display: "flex", justifyContent: "space-between", fontSize: "13px" }}>
            <span style={{ color: "#888" }}>Estampado (nombre + numero)</span>
      ...
      <div style={{ background: "#1a1400", border: "1px solid #854d0e", borderRadius: "14px", padding: "20px", marginBottom: "16px" }}>
        ...
        <div style={{ fontSize: "28px", fontWeight: 900, color: "#f59e0b", marginBottom: "6px" }}>14 - 20 dias</div>
        <div style={{ fontSize: "13px", color: "#888", lineHeight: 1.6 }}>Una vez confirmado y pagado el pedido, el tiempo estimado de llegada es de 14 a 20 dias habiles.</div>
      </div>
      <div style={{ background: "#1a0a0a", border: "1px solid #7f1d1d", borderRadius: "14px", padding: "20px", marginBottom: "16px" }}>
        <div style={{ fontSize: "18px", fontWeight: 700, marginBottom: "10px" }}>Disponibilidad</div>
        <div style={{ fontSize: "14px", color: "#ccc", lineHeight: 1.7 }}>Todos los pedidos estan sujetos a confirmacion de disponibilidad del articulo. En caso de no estar disponible, te avisaremos a la brevedad.</div>
      </div>
      <div style={{ background: "#141414", border: "1px solid #1e1e1e", borderRadius: "14px", padding: "20px", marginBottom: "16px" }}>
        <div style={{ fontSize: "18px", fontWeight: 700, marginBottom: "14px" }}>Como comprar?</div>
        <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
          {[["1","Elige tu camiseta del catalogo"],["2","Selecciona talla, version y si quieres estampado"],["3","Agrega al carrito"],["4","Ingresa tus datos y confirma el pedido"],["5","Te contactamos por WhatsApp para coordinar pago y entrega"]].map(([n,t]) => (
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}>
        ...
        <div style={{ background: "#1a1400", border: "1px solid #f59e0b", borderRadius: "14px", padding: "18px" }}>
          ...
          <div style={{ fontSize: "13px", color: "#888" }}>Se encarga. Tiempo: 14-20 dias.</div>
        </div>
      </div>
    </div>
  )
